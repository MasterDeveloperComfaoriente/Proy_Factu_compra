...
# Server:  https://wsconsultarpdfxmlfactura.dispafel.com:443/DFFacturaElectronicaConsultarPdfXmlFactura/consultarArchivos
#-------------------------------------------------------------------------------
...
FUNCTION consultarArchivos_g()
  ...
  IF consultarArchivos_ConsultarArchivosPortEndpoint.Address.Uri IS NULL THEN
    LET consultarArchivos_ConsultarArchivosPortEndpoint.Address.Uri = "https://wsconsultarpdfxmlfactura.dispafel.com:443/DFFacturaElectronicaConsultarPdfXmlFactura/consultarArchivos"
  END IF
